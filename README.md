...
-   Full installation instructions for downloading DITA-OT can be found
    [here](https://www.dita-ot.org/3.5.2/topics/installing-client.html).

    1.  Download the `dita-ot-3.5.2.zip` package from the project website at
...
```console
curl -LO https://github.com/dita-ot/dita-ot/releases/download/3.5.2/dita-ot-3.5.2.zip
unzip -q dita-ot-3.5.2.zip
rm dita-ot-3.5.2.zip
```
